...
import (
	...
	api "github.com/yuwenma/kubebuilder-declarative-pattern/examples/guestbook-operator/api/v1alpha1"

	"github.com/yuwenma/kubebuilder-declarative-pattern/pkg/test/golden"
)
